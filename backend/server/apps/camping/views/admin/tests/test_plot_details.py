...
from server.apps.camping.views.admin import AdminCampingPlotDetailsView
...
class AdminCampingPlotDetailsViewTestCase(AccountViewPermissionsTestMixin, APITestCase):
    @classmethod
    def setUpTestData(cls):
        cls.factory = APIRequestFactory()
        cls.view = AdminCampingPlotDetailsView
        cls.viewname = 'admin_camping_plot_details'
    ...
    def test_request(self):
        parameters = {'pk': self.camping_plot.id}
