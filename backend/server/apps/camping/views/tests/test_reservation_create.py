...
class ReservationCreateViewTestCase(AccountViewPermissionsTestMixin, APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.viewname = 'reservation_create'
