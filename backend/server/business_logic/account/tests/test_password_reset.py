...
class AccountPasswordResetBLTestCase(TestCase):
    ...
    @mock.patch.object(AccountPasswordResetMail, 'send')
    @mock.patch.object(PasswordResetTokenGenerator, 'make_token')
    ...
    def test_process(self, get_account_by_email_mock, make_token_mock, send_mail_mock):
        ...
        AccountPasswordResetBL.process(email=self.account.email)
    ...
    def test_process_for_not_existing_account(self, get_account_by_email_mock, make_token_mock, send_mail_mock):
        ...
        with self.assertRaises(AccountEmailNotExistsError):
            AccountPasswordResetBL.process(email=email)
    ...
    @mock.patch.object(PasswordResetTokenGenerator, 'make_token')
    @mock.patch.object(AccountQuery, 'get_by_email')
    def test_process_for_inactive_account(self, get_account_by_email_mock, make_token_mock, send_mail_mock):
