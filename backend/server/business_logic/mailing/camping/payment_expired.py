...
class PaymentExpiredMail(AbstractMailBL):
    _subject_template = _('PaymentExpiredEmailSubject')
    _message_template = 'mailing/camping/payment_expired.html'
    _logger_message = ConsumerMessagesEnum.ENQUEUED_PAYMENT_EXPIRED_TO_MAIL.value
